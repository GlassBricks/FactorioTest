...
const testCases: TestCase[] = [
  ...
  },
  {
    ...
    modPath: "../integration-tests/fixtures/only-test-mod",
    args: ["--no-forbid-only"],
    expectedOutput: ["only-test-mod: completed", "Tests:", "passed"],
    expectExitCode: 0,
  },
  {
  ...
  },
  {
    ...
    args: ["--bail"],
    expectedOutput: ["FAIL test1 > each 2", "Bailed out after 1 failure(s)", "Failures:", "Tests:", "failed"],
  ...
  },
  {
    ...
    args: ["--bail=2"],
    expectedOutput: ["FAIL test1 > each 2", "PASS test1 > In world", "Failures:", "Tests:", "failed"],
