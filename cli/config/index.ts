export { testRunnerConfigSchema, registerTestConfigOptions, parseCliTestOptions } from "./test-config.js"
export type { TestRunnerConfig } from "./test-config.js"

export { cliConfigSchema, registerCliConfigOptions, registerCliOnlyOptions } from "./cli-config.js"
